 ...
 */
package com.vyomlabs8.uiautomation.sample;
...
import  com.vyomlabs8.uiautomation.sample.steps.TestUIGivenState;
import  com.vyomlabs8.uiautomation.sample.steps.TestUIThenState;
import  com.vyomlabs8.uiautomation.sample.steps.TestUIWhenState;

/**
 * Dummy use case. This test shows the sample code 
 * It just does a login operation.
...
public class UIAutomationSuite extends UIBaseTest<TestUIGivenState, TestUIWhenState, TestUIThenState>{
	...
	//First Set the application bundle name to be tested here.
	 public String getApplicationName(){
    	return "com.vyomlabs8.application8";
    }
    ...
    // Here Task Manager.
    private final String bundleName = "com.vyomlabs8.application8";
        
	@BeforeClass
	public void init(){
		super.beforeClass();
		
		//read the details from the config file.
		userName = AutoConfig.getUsername();
		userPassword = AutoConfig.getPassword();
	}
	...
	public void setup(){
		...
		//This method will launch the url set before.
		openApplication();
	}
